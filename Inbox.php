  ...
  <body class="bg-body-tertiary">
    ...
    <?php require 'partials/_header.php';
      ...
      if(isset($_POST['Send'])){
        ...
        // $sql = "UPDATE `inbox` SET `name` = '$name', `mobile` = '$mobile' WHERE `myInformation`.`username` = '{$_SESSION['username']}' ";
        $sql = "INSERT INTO `inbox` (`id`, `sender`, `center_person`, `messege`, `sent_time`) VALUES (NULL, '{$_SESSION['username']}', '{$_SESSION['username']}', '$messege', current_timestamp()); ";
      ...
      <div class="row" style="margin-bottom:100px;">
        <div class="col-5" style="">
          <form action="" method="post">
            ...
            <div class="mb-3">
              <label for="messege" class="form-label"><b>Your Messege</b></label>
          ...
          <!-- <div class="container my-4"> -->
            <table id="data" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                <!-- php MySQL query -->
                <?php
                $sql = "SELECT * FROM `inbox` WHERE `center_person` LIKE '{$_SESSION['username']}' ";
                $result = mysqli_query($conn, $sql);
                $sn = 0;
