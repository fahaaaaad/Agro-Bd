...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  if(isset($_POST['snoEdit'])){
    ...
    $sql ="UPDATE `fishFeed` SET `price` = '$newPrice' WHERE `fishFeed`.`sno` = '$sno'";
...
if(isset($_GET['delete'])){
  ...
  $sql = "DELETE FROM `fishFeed` WHERE `sno` = '$sno'";
  $result = mysqli_query($conn, $sql);
  if($result){
    $delete = true;
  }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form action="fishFeedTable.php" method="POST" style="min-width: fit-content;">
...
?>
    ...
    <div class="container"style="max-width: 900px; margin-top: 70px; margin-bottom: 200px; ">
      <div class="row d-flex justify-content-center" style="margin-bottom:79px;">
        <u class="col-auto" ><h2 style=" ">Fish Feed Product Table</h2></u>
        <!-- <hr/> -->
      ...
      Array.from(deletes).forEach((element)=>{
        element.addEventListener("click", (e) => {
          ...
          if(confirm("Are you sure you want to remove this entry!")){
            console.log("yes");
            window.location = `fishFeedTable.php?delete=${sno}`;
          }
          else{
            console.log("no");
          }
