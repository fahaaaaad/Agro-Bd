    ...
    <div class="container my-5 text-center"> <!-- Added text-center class -->
      <div class="d-sm-flex flex-sm-column align-items-center"> <!-- Added align-items-center class -->
        <h1 class="section-header landing-section-title title-font">
          Aquaculture Tools and Supplies
        </h1>

        <div class="landing-section-content">
          <div>Unlock the potential of your aquaculture with our comprehensive range of high-performance tools and supplies for efficient and profitable operations. </div>
          <div>Empower your aquaculture operation with top-quality tools and supplies tailored for success.</div>
        </div>
      </div>
    </div>
