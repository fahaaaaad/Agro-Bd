    ...
    <div class="container my-5 text-center"> <!-- Added text-center class -->
      <div class="d-sm-flex flex-sm-column align-items-center"> <!-- Added align-items-center class -->
        ...
        <div class="landing-section-content">
          <div>Unlock the potential of your fish farm with our comprehensive range of high-quality feeds for efficient and profitable farming. </div>
          <div>Grow your fishes with top-quality feeds tailored for success.</div>
        </div>
      </div>
    </div>
