...
<div class="container fixed-top" style="padding-left: 0; padding-right: 0; min-width: -moz-available;">
  <div class="row" style="min-width: -moz-available;">
                      ...
                      <ul>
                        <li class="nav-item dropdown"><a href="#">Animal Farming<i class="fas fa-caret-right"></i></a>
                          ...
                          <div class="dropdown-menu-1">
                            <ul>
                              <li class="nav-item dropdown" style="padding-top: 12px;"><a href="cow.php">Cow</a></li>
                              <li>
                        ...
                        <li><a href="#">Fisheries<i class="fas fa-caret-right"></i></a>
                          ...
                          <div class="dropdown-menu-1">
                            <ul>
                              <li style="padding-top: 12px;"><a href="#">Carp</a></li>
                              <li>
                                <hr class="dropdown-divider">
                              </li>
                              <li style="padding-bottom: 12px;"><a href="#">Prawn</a></li>
                            </ul>
                          </div>
                        </li>
                        <li>
                        ...
                        <li><a href="#">Poultry<i class="fas fa-caret-right"></i></a>
                          ...
                          <div class="dropdown-menu-1">
                            <ul>
                              <li style="padding-top: 12px;"><a href="#">Chicken</a></li>
                              <li>
                                <hr class="dropdown-divider">
                              </li>
                              <li><a href="#">Duck</a></li>
              ...
              <div class="menu-bar" style="padding-left: -15px;">
                <ul>
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                      <ul>
                        <li><a href="farming_sector.php">For Farmers</a></li>
                        <li>
                          <hr class="dropdown-divider">
                        </li>
    ...
    <div class="col">
      <ul class="nav justify-content-center bg-secondary ">
        <li class="nav-item">
          <a class="nav-link link-dark link-opacity-75" aria-current="page" href="#">Active</a>
        </li>
        <li class="nav-item">
          <a class="nav-link link-dark link-opacity-75" href="#">Link</a>
        </li>
        <li class="nav-item">
          <a class="nav-link link-dark link-opacity-75" href="#">Link</a>
        </li>
        <li class="nav-item">
          <a class="nav-link link-dark link-opacity-75">Disabled</a>
        </li>
      </ul>
    </div>
