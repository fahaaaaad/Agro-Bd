    ...
    if(isset($_FILES['photo'])){
      ...
      if($photo_size > 5242880){
        ...
        if($num > 0){
          ...
          $sql = "INSERT INTO `blog` (`id`, `name`, `image`, `stories`) VALUES (NULL, '$name', '$photo_new_name', '$stories')";
          $result = mysqli_query($conn, $sql);
          if($result){
            $enter = true;
            // $showAlert = true;
      ...
      if($enter){
        echo '
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Success!</strong> Updated successfully in the DataBase!
      ...
      if($blogExists){
        echo '
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Error!</strong> blog title already exists!!!
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            ';
      }
    ...
    <div class="row d-flex justify-content-center" style="margin-bottom:65px;">
      ...
      <form action="" method="POST" enctype="multipart/form-data"  style="min-width: 800px;">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="stories" name="stories" required></textarea>
        ...
        <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
          ...
          <div>
            <input
              ...
              style="float:right; margin-right:22px; margin-top:7px; background-color: rgba(44, 19, 225, 0.91); color: white; width: 90px;" 
            />
          </div>
